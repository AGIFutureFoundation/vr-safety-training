...
export const ROOM_PHLEBOTOMY = {
  ...
  steps: [
    ...
    },
    {
      ...
      why: "Seventy per cent alcohol needs its contact time and then needs to air dry; the drying is part of the antisepsis and not a pause before it. Wet alcohol carried into the vein stings sharply and haemolyses the sample, and haemolysis releases potassium from the cells — enough to have a perfectly well patient treated for hyperkalaemia.",
    },
    {
      ...
      why: "Fifteen to thirty degrees, bevel up, with the vein anchored by your thumb below the site. Too shallow and the bevel skates over a vein that rolls away from it; too steep and you go through the back wall into tissue — or, working the medial side of the antecubital fossa, into the brachial artery and the median nerve lying alongside it.",
      gauge: {
    ...
    },
    {
      ...
      why: "Labelling happens here, at the chair, after the draw, with the patient still in front of you and the band still readable. Every metre between the tube and the person is a chance for it to become somebody else's sample, and a mislabelled tube arrives at the lab indistinguishable from a correct one — the error surfaces in the treatment it causes.",
    },
  ],
