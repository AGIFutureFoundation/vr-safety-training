...
export const SIM_TOWER_CLIMB = {
  ...
  hazards: {
    ...
    "live-antenna-panel": "That antenna panel is still transmitting. RF at this range heats tissue from the inside with no sensation to warn you until after the exposure, and stray current will arc into an ungrounded tool the instant it touches the feed line. The permit's 2.5 mW/cm² figure is the ANSI/IEEE-derived exposure limit the FCC enforces.",
    "loose-tool": "That wrench is sitting untethered on the platform grating. Eighty feet of fall puts a two-pound wrench on the ground at over forty miles an hour, and a hard hat is tested against a fraction of that energy — dropped objects are consistently among the leading causes of death in tower work.",
  ...
  steps: [
    ...
    },
    {
      ...
      why: "Anything untethered is a dropped object the moment a glove slips, a hand cramps or a gust hits. Tethering is a ground task because it is the one place you can do it with both hands free and nothing below you — there is no safe way to fit a tool lanyard while standing on grating eighty feet above your own crew.",
    },
    {
      ...
      why: "A guyed mast stands up because its guys are in tension; the ANSI/TIA-322 loading criteria the structure was designed to assume every strand is there and every anchor is sound. Weather and corrosion do not wait for the annual inspection, so the pre-climb walk is a search, not an assumption that yesterday's tower is today's tower.",
    },
    {
    ...
    {
      id: "work-task", kind: "turn", target: "antenna-work",
      title: "Replace the antenna mounting bracket",
      cue: "Fit the new bracket and run the mount bolts down to torque with the tethered wrench.",
      why: "The repair only happens once every control ahead of it is in place — locked-out RF, inspected structure, tied-off climber. Then it is a torque job: a mount bolt left finger-tight will back itself out under the wind loading ANSI/TIA-322 assumes this structure sees, and the panel it is holding is the next dropped object.",
      turn: { turns: 2, axis: "y", label: "MOUNT BOLTS — TORQUE PASS", readout: (t) => `${Math.round(t * 100)}% seated` },
    },
    {
    ...
    },
    {
      ...
      why: "The lock comes off last, by the person who put it on, once every climber has personally confirmed clear of the structure — a headcount, not an assumption that the last person down was the last person up. Restoring a carrier with somebody still on the mast is precisely the event the lockout existed to prevent.",
    },
  ],
