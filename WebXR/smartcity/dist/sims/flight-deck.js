  ...
  steps: [
    {
      ...
      why: "Airspace and ramp status change by the hour under 14 CFR Part 107 small-UAS operating rules. Working under an aircraft that the fleet scheduler expects to be flying at 14:20 is how a ground crew ends up standing under a live approach with no warning it is coming.",
    },
    {
      ...
      why: "The zone keeps bystanders off an active ramp and keeps you inside a boundary the flight controller's automated landing logic actually respects — the same OSHA ramp-safety logic that applies to ground crews under any aircraft, crewed or not.",
    },
    {
      ...
      why: "Disarmed means the motors cannot spin regardless of what a stray signal, a bumped stick or a fleet scheduler's queued mission commands them to do. Nothing touches the airframe before this is confirmed on the link, not assumed from how quiet the rotors look.",
    },
    {
      ...
      why: "Disarmed is a software state that a dispatcher in an office can silently overwrite; the pin is physical and nobody can push a firmware update through it. Both together, not either alone, are what makes an accidental spin-up impossible instead of merely unlikely.",
    },
    {
      ...
      why: "A pre-flight inspection is a search, not a checklist tick, and it is the finding the incident report reads first if the release goes ahead without it. Damage that looks cosmetic sitting on the ramp is structural the moment it is loaded at altitude.",
    },
    {
      ...
      why: "Matched, balanced propellers keep the airframe's vibration profile inside what the flight controller expects from its accelerometers. A chipped blade throws that profile off just enough that the controller starts compensating for damage instead of flying the mission.",
    ...
    },
    {
      ...
      why: "The battery bay is the last thing on the airframe that opens, and only after the aircraft cannot spin a motor even if you drop a tool into it. A swollen LiPo cell is already venting internally, and NFPA's guidance on lithium battery hazards treats that as a fire risk the instant it is found, not a defect to fly around.",
    },
    {
      ...
      why: "A pack with one cell drifting low will sag under load exactly when the aircraft needs full power to land, not while it is cruising at altitude with margin to spare. Balance is checked before every single flight, not just at charge time when the pack was last on the bench.",
      gauge: {
    ...
    },
    {
      ...
      why: "A venting lithium cell in a normal storage bin can ignite everything stacked around it within seconds. The fireproof bag, the same NFPA-recommended containment used across the trade for damaged lithium packs, buys the minutes it takes to get it somewhere it can vent safely.",
    },
    {
      id: "unpin", kind: "select", target: "prop-pins",
      title: "Remove the rotor pins",
      cue: "Pull all four pins once the inspection is complete.",
      why: "The pins are the last thing an IAM-trained ground technician does at the aircraft itself. Everything after this — the route, the upload, the verification — happens at the console, so nothing puts a hand near the airframe again between the pins coming out and the release being signed.",
    },
    {
      ...
      why: "The flight controller flies the waypoints in the exact order they were entered, not the order that looks correct on the map. Swap the relay and the delivery point and the aircraft plans a straight line through restricted airspace instead of the corridor around it.",
    ...
    },
    {
      ...
      why: "A planned route sitting on the tablet is not a flight plan yet — it is a drawing. Uploading it is the step that actually replaces whatever the aircraft was flying before with the route you just built and checked.",
    },
    {
      ...
      why: "Airspace restrictions shift by the hour under Part 107 operating rules, so a corridor that was clear when the route was drawn an hour ago may not be clear now. You verify the specific route you are about to fly, every single time, not the general area it happens to pass through.",
    ...
    },
    {
      ...
      why: "The release is a signed record that one named, IAM-certified technician personally checked specific things on this specific airframe today. It is the document an incident investigation reads first if something goes wrong in the air twenty minutes from now.",
    },
  ],
