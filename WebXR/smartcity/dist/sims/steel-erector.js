  ...
  steps: [
    {
      ...
      why: "The raising gang works one pick at a time from a sequence the engineer set for a reason — steel goes up out of order and the structure is not stable for the next pick.",
    },
    {
      ...
      why: "The lifeline runs the length of the beam you are about to walk. Nothing else on a structural floor is rated to catch you before it exists.",
    },
    {
      ...
      why: "A connector's harness gets checked at the start of every shift it is worn on steel — this is not equipment you find out has failed after it already has.",
    },
    {
      ...
      why: "The operator cannot see the connection point from the cab. Every signal that moves the load has to mean the same thing to everyone on the pick or the load moves on a guess.",
    },
    {
    ...
    },
    {
      ...
      why: "The tag line keeps your hands a rope's length from a ton of moving steel while still giving you enough control to place it precisely.",
    ...
    },
    {
      ...
      why: "The splice plate is machined to take the column's base exactly once it is aligned — forcing a mismatched landing bends the plate before the first bolt goes in.",
    },
    {
      ...
      why: "Every connection above this one inherits whatever lean you accept here. Plumb now is the only point in the sequence where it is still cheap to fix.",
      gauge: {
    ...
    },
    {
      ...
      why: "Temporary bolts hold the connection snug while it is checked and plumbed. The erection bolt goes in last, once the joint is already stable enough that adding it does not shift the alignment.",
    ...
    },
    {
      ...
      why: "Final torque only happens once the minimum number of bolts is in and the connection is confirmed plumb — it is the last thing that happens, never a shortcut to skip the temporary bolts.",
    },
    {
      ...
      why: "The crane hook does not come off until the connection is logged as self-supporting. The record is what the inspector and the next raising gang inherit.",
    },
  ],
