...
import {
  CITY, stationPad, holoPanel, holoTag, toolChest, cone, instrument, standingFigure, reg,
} from "../citykit.js";
  ...
  steps: [
    {
      ...
      why: "The plan names the well, what the lab will analyse, which bottle fills first and how long each has before it is worthless. You read it here, not at the cooler.",
    },
    {
      ...
      why: "The gloves protect you from the water and the water from you — a fingerprint of yesterday's well is cross-contamination. New pair, every well.",
    },
    {
      ...
      why: "The casing can hold vapour. The meter goes to the opening first; the reading tells you whether this is a routine well or a respirator well.",
    },
    {
      ...
      why: "Depth to water sets where the intake goes and is the baseline drawdown is measured against. It is the first number on the field sheet because everything after depends on it.",
      gauge: {
    ...
    },
    {
      ...
      why: "The intake sits in the screen, mid-interval, so what you draw is formation water at that depth — not casing water above it, not sediment below it.",
    ...
    },
    {
      ...
      why: "From here the bottle is evidence. The form is the unbroken line from this casing to the lab bench, and every hand it passes through signs it.",
    },
    {
      id: "cooler", kind: "hold", target: "cooler", seconds: 3,
      title: "Pack on ice",
      cue: "Bottles into the cooler, ice on top, hold the lid down until it seals.",
      why: "Most holding times assume the sample is at 4 °C from the minute it is taken. Warm on the tailgate for an hour and the metals are fine and the volatiles are gone.",
    ...
    },
    {
      ...
      why: "The lab trusts the label. A mismatch caught here is a pen stroke; caught at the bench, it is a resample and a report nobody can use.",
    },
  ],
