...
export const SIM_SOLAR_DECK = {
  ...
  steps: [
    ...
    },
    {
      ...
      why: "Rapid shutdown drops the array conductors outside the modules to a safe touch voltage within seconds of the initiator being pressed. It is the rapid-shutdown requirement that makes rooftop PV wiring approachable in daylight at all — without it, an array under sun is simply a live circuit.",
    },
    {
      ...
      why: "DC first, always. Opening the AC side while DC is still feeding the inverter leaves stored energy and a live front end sitting behind the cover you are about to work near — the inverter has to lose its source before it loses its grid connection.",
    ...
    },
    {
      ...
      why: "Now the inverter has neither a DC source feeding it nor a grid connection to push back into. Both sides open, in that order, is what makes the equipment actually isolated for electrical safe work purposes under NFPA 70E, rather than just sitting quiet.",
    ...
    },
    {
      ...
      why: "Measuring Voc against the expected value for this string's module count, wiring and temperature is how you find a missing module, a reversed pair or a shaded run before you ever energise — after commissioning, the same fault just looks like reduced output nobody can explain.",
      gauge: {
    ...
    },
    {
      ...
      why: "Polarity first, because an insulation test on a reversed string tells you nothing useful and can damage the tester by driving current the wrong way through it. Earth continuity comes last because it confirms the protective bonding path every reading before it has been quietly relying on.",
    ...
    },
    {
      ...
      why: "A battery commissioned at the extremes of its charge window — nearly empty or nearly full — cannot be balanced properly across its cells, and the first charge cycle is exactly when that imbalance shows up as one cell ageing faster than the other five.",
      gauge: {
    ...
    },
    {
      ...
      why: "Energise AC then DC — the exact reverse of how you isolated — watch the inverter come up clean, and record every reading you took. The commissioning record is what the next technician inherits instead of guessing at this array's baseline from scratch.",
    },
  ],
