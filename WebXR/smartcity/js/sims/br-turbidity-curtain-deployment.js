...
export const SIM_BR_TURBIDITY_CURTAIN_DEPLOYMENT = {
  ...
  build(root) {
    ...
    const buoyUp = group(g, -4.6, 0.02, -4.6);
    ...
    const pts = [[-4.6, -4.6], [-4.4, -6.4], [-2.6, -7.6], [0, -8.0], [2.4, -7.4], [4.0, -5.8], [4.6, -4.0], [4.6, -2.4]];
    const segs = [];
    ...
    line.visible = false;
    const anchorMarks = {};
    for (const [id, x, z, label] of [["anchor-2", -2.6, -7.3, "anchor 2"], ["anchor-3", 2.4, -7.1, "anchor 3"]]) {
    ...
    const debris = group(g, 0.2, 0.02, -7.7);
    ...
    const drowned = box(g, 0.9, 0.04, 0.2, 4.35, -0.02, -5.0, 0x8a7a2a, { rough: 0.8, emissive: 0x2a2206, ei: 0.3 });
    ...
    const shortcut = group(g, -3.6, 0.02, -5.8);
