...
export const SIM_ROBOT_CELL = {
  ...
  game: system({
    ...
    badges: [
      ...
      { id: "path-taught", name: "Path Taught", note: "Teach every waypoint in the correct order, first try", test: AWARD.stepClean("teach-points") },
    ],
    challenges: [
  ...
  steps: [
    ...
    },
    {
      ...
      why: "A taught path is only as safe as the order it was recorded in — teach the transfer point after place and the arm swings back through the fence line on playback instead of clearing it.",
    ...
    },
    {
      ...
      why: "An untaught point list is just jog history. Saving it is what turns three recorded positions into a program the controller can actually execute.",
    },
    {
      ...
      why: "You verify a brand-new program at teach speed with your hand on the pendant's dead-man switch, watching every point, before it ever runs unattended at full production speed.",
