  ...
  steps: [
    {
      ...
      why: "The scaffold plan is the competent person's design under OSHA's 29 CFR 1926.451 and ANSI A10.8 — how high, how tied, how loaded, and what ground it assumes underneath it. Erection follows that plan on site; improvising a taller build, a different tie pattern or a heavier load than the plan calls for turns a designed structure into a guess nobody has checked.",
    },
    {
      ...
      why: "Everything above the mudsills stands on this footprint alone. Soft ground, uncompacted backfill or a low spot that will pond water settles under load once the frames go up, and a scaffold that racks toward one settling leg is carrying its weight through connections designed to go straight down, not sideways.",
    },
    {
    ...
    },
    {
      ...
      why: "The first lift sets the alignment for everything stacked on it later — square, plumb and braced now is square, plumb and braced at four lifts; out of square now multiplies at every lift after. It goes onto the base plates, gets braced both sides, and nobody lets go of the frame until the braces are actually pinned, not just leaned against it.",
    ...
    },
    {
      ...
      why: "Out of plumb at the first lift does not stay small — it doubles at the second lift and compounds at every one after that, and by four lifts up a small lean at the base has become a structure visibly leaning off the wall. The screw jacks get adjusted now, while the scaffold is one lift high, light, and still easy to move by hand.",
    ...
    },
    {
      ...
      why: "The tie is what makes this a structure fastened to the building instead of a free-standing tower carrying its own wind load — NIOSH fatality investigations into scaffold collapses keep finding the same missing element, a tie pattern that was never installed or was installed after the fact. It goes in at the first lift, torqued to the coupler figure, before a second lift raises the wind-sail height any further.",
    ...
    },
    {
      ...
      why: "The second lift only goes up once the first is plumb, level and tied — stacking height onto an unchecked lift just carries the same error higher and adds weight the tie was never sized for. Coupling pins go in so the frames cannot lift off the legs below them, and braces go on both sides so the two lifts cannot rack independently of each other.",
    ...
    },
    {
      ...
      why: "Full planking is the only floor the crew above ever stands on — a gap wide enough to step through is a leg through the platform onto the lift below, and a plank laid but not cleated to the ledger is a plank that walks sideways the first time someone's weight shifts near its edge, dropping whoever was standing on it.",
    ...
    },
    {
      ...
      why: "The ladder is how the scaffold gets used every day after it is built, not just how it gets erected once. Without a proper access point fitted before the platform opens, the first person up climbs the cross-braces because that is what is there, and every person after them learns that climbing the frames is normal, right up until a foot goes through a brace that was never meant to carry it.",
    },
    {
      ...
      why: "The green tag is the competent person's signature on a claim that every connection, tie, plank and guardrail was actually checked, not assumed. The inspection is the work that has to happen before that word means anything — walking every pin, coupler and tie by hand rather than looking at the structure from the ground and deciding it looks fine.",
    },
    {
