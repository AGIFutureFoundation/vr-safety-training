...
export const SIM_ELEVATOR_PIT = {
  ...
  steps: [
    ...
    },
    {
      ...
      targets: ["cartop-stop-switch", "pit-stop-switch", "lockout-hasp", "main-disconnect"],
      itemNames: {
        "cartop-stop-switch": "car-top stop switch", "pit-stop-switch": "pit stop switch", "lockout-hasp": "your lock off the hasp", "main-disconnect": "main line disconnect",
      },
