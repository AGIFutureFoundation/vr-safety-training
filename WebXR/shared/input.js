...
export const INPUT_ACTIONS = [
  ...
  { id: "view", group: "assist", label: "First / third person", what: "Switches between the first-person view and a third-person camera that follows your own figure — or the vehicle, on a drive step." },
...
export const KEYBOARD_PRESETS = {
  standard: {
    ...
    keys: {
      ...
      turnRight: ["KeyE"],
      speakHint: ["KeyH"],
      // `V` is the third-person toggle everywhere (the common convention);
      // voice moves to the free `N` so it stays reachable with one press.
      voice: ["KeyN"],
      mute: ["KeyM"],
      view: ["KeyV"],
      controls: ["Slash", "F1"],
  ...
  "left-hand": {
    ...
    keys: {
      ...
      speakHint: ["KeyT"],
      voice: ["KeyB"],
      // Mute moves to the free `X`, still on the left third, so `V` stays the
      // view toggle everywhere.
      mute: ["KeyX"],
      view: ["KeyV"],
  ...
  "one-hand": {
    ...
    keys: {
      ...
      hold: ["Space"],
      adjustUp: ["KeyR"],
      // Adjust-down moves to the free `D`, still one key over from `F`/`R`,
      // so `V` stays the view toggle everywhere.
      adjustDown: ["KeyD"],
      turnLeft: ["KeyQ"],
      turnRight: ["KeyE"],
      speakHint: ["KeyT"],
...
export const GAMEPAD_MAP = [
  ...
  { index: 11, mode: "edge", action: "view", note: "Right stick press: switches between first- and third-person view." },
...
export const DRIVE_GAMEPAD_MAP = [
  ...
  { index: 11, mode: "edge", action: "view", note: "Right stick press: chase view behind the vehicle, or back to the cab." },
];
...
export const VOICE_GRAMMAR = [
  ...
  { type: "thirdPerson", scope: "any", phrases: ["third person"], what: "Switches to the third-person camera behind your own figure — or the vehicle, on a drive step.", re: /\bthird[- ]?person\b/ },
  { type: "firstPerson", scope: "any", phrases: ["first person"], what: "Switches back to the first-person view.", re: /\bfirst[- ]?person\b/ },
