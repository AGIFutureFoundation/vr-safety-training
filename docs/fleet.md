...
| Kit | File | Builders |
|---|---|---|
| Fleet | `WebXR/shared/fleet.js` | tractors (day cab, sleeper), four trailers, a coupled tractor-trailer, box truck, pickup, sedan, cargo van, ambulance, fire engine, bucket truck, transit bus, forklift, yard hustler, workboat |
