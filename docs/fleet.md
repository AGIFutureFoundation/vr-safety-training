...
|---|---|---|---|---|
| <img src="screenshots/fleet/semiTractor.jpg" width="200" alt="semiTractor"> | **semiTractor** — Class 8 day cab, tandem drive, fifth wheel, air lines and glad hands. `semiTractor(parent, x, y, z)` | 24 / 85 | 3.02 × 3.95 × 6.86 | doorL, doorR, mirrorL, mirrorR, hood, wheels, lights, headlights, markerLights, tailLights, fifthWheel, fifthWheelRelease, gladHandService, gladHandEmergency |
| <img src="screenshots/fleet/semiTractor-sleeper.jpg" width="200" alt="semiTractor:sleeper"> | **semiTractor:sleeper** — Class 8 raised-roof sleeper. `semiTractor(parent, x, y, z, {cab: "sleeper"})` | 24 / 86 | 3.02 × 4 × 8.66 | doorL, doorR, mirrorL, mirrorR, hood, wheels, lights, fifthWheel, gladHandService, gladHandEmergency |
...
| <img src="screenshots/fleet/trailer-pup.jpg" width="200" alt="trailer:pup"> | **trailer:pup** — 28 ft single-axle pup van, the length a station can park side-on inside the apron fence. `trailer(parent, x, y, z, {kind: "pup"})` | 13 / 41 | 2.63 × 4.11 × 8.65 | doorL, doorR, wheels, landingGear, gladHands, lights |
| <img src="screenshots/fleet/tractorTrailer.jpg" width="200" alt="tractorTrailer"> | **tractorTrailer** — day cab coupled to a 53 ft dry van; `{trailer: "pup"}` couples the 28 ft pup instead (13.1 m overall). `tractorTrailer(parent, x, y, z)` | 38 / 129 | 3.02 × 4.11 × 20.71 | tractor, trailer |
...
| <img src="screenshots/fleet/excavator.jpg" width="200" alt="amphibiousExcavator"> | **amphibiousExcavator** — the same upperstructure on twin steel flotation pontoons in place of crawler tracks: the "swamp buggy" a shoreline or wetland crew calls in where the ground will not carry a standard tracked machine. `amphibiousExcavator(parent, x, y, z)` | 22 / 48 | 4.65 × 5.21 × 10.81 | pontoonL, pontoonR, house, door, boom, stick, bucket, lights, counterweight |
