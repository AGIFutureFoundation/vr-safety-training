...
export const SMARTCITY_SIMS = [
  ...
  "boiler-room", "elevator-pit", "abatement-chamber", "rigging-loft", "line-truck", "dock-crane", "hunters-point", "air-monitor", "sampling-well", "press-brake", "decon-line", "stage-power",
];
