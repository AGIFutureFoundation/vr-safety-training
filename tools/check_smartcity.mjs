...
const MODULES = [
  ...
  "smartcity/js/sims/hw-housekeeping-cart-and-chemical-safety.js",
  "smartcity/js/sims/hw-banquet-room-flip-and-staging.js",
  "smartcity/js/sims/hw-flatwork-ironer-and-folder-guarding.js",
  "smartcity/js/sims/cs-permit-entry-and-attendant-duties.js",
  "smartcity/js/sims/cs-ventilation-and-air-monitoring-plan.js",
  "smartcity/js/sims/cs-non-entry-retrieval-and-tripod.js",
  ...
  "smartcity/js/sims/drive-night-fog-and-rail-crossing.js",
  "smartcity/js/sims/drive-backing-serpentine-and-alley-dock.js",
  "smartcity/js/sims/drive-light-vehicle-fleet-and-forklift-course.js",
  ...
  "smartcity/js/sims/bb-scrimmage-and-sportsmanship-debrief.js",
  "smartcity/js/sims/cv-open-meeting-law-and-agenda-notice.js",
  "smartcity/js/sims/cv-voter-registration-drive-and-nonpartisan-conduct.js",
  "smartcity/js/sims/cv-neighborhood-emergency-block-captain.js",
  "smartcity/js/sims/cv-restorative-justice-circle-facilitation.js",
  "smartcity/js/sims/cv-grant-application-and-nonprofit-compliance.js",
  "smartcity/js/sims/cv-difficult-conversation-across-difference.js",
  "smartcity/js/sims/dn-digital-intraoral-scanning-and-cad-cam.js",
  "smartcity/js/sims/dn-dental-trauma-and-avulsed-tooth-response.js",
  "smartcity/js/sims/dn-medical-history-and-medication-review.js",
  "smartcity/js/sims/dn-oral-hygiene-instruction-and-motivational-interviewing.js",
  "smartcity/js/sims/dn-dental-coding-billing-and-preauthorisation.js",
  "smartcity/js/sims/dn-public-health-dentistry-and-fluoridation-advocacy.js",
  "smartcity/js/sims/bs-structural-bolting-and-torque.js",
  "smartcity/js/sims/bs-tandem-lift-girder-set.js",
  "smartcity/js/sims/bs-bearing-replacement-and-jacking.js",
  "smartcity/js/sims/bt-formwork-stripping-and-reshoring.js",
  "smartcity/js/sims/bt-rebar-tying-and-impalement-protection.js",
  "smartcity/js/sims/bt-masonry-wall-layout-and-mortar.js",
  "smartcity/js/sims/br-dive-site-hazard-assessment-and-jsa.js",
  "smartcity/js/sims/br-surface-supplied-dive-station-setup.js",
  "smartcity/js/sims/br-underwater-debris-survey-and-mapping.js",
  "smartcity/js/sims/br-underwater-sediment-core-sampling.js",
  "smartcity/js/sims/br-derelict-gear-recovery-dive.js",
  "smartcity/js/sims/br-hyperbaric-chamber-standby.js",
  "smartcity/js/sims/br-dive-tender-and-umbilical-management.js",
  "smartcity/js/sims/br-derelict-vessel-salvage-rigging.js",
  "smartcity/js/sims/br-workboat-crane-lift-from-water.js",
  "smartcity/js/sims/br-debris-skimmer-vessel-operations.js",
  "smartcity/js/sims/br-boom-towing-between-two-vessels.js",
  "smartcity/js/sims/br-barge-loading-of-contaminated-sediment.js",
  "smartcity/js/sims/br-dredge-spoils-dewatering-pad.js",
  "smartcity/js/sims/br-turbidity-curtain-deployment.js",
  "smartcity/js/sims/br-sediment-chain-of-custody-and-lab-prep.js",
  "smartcity/js/sims/br-water-quality-sonde-calibration-and-deploy.js",
  "smartcity/js/sims/br-legacy-mercury-and-pcb-hotspot-handling.js",
  "smartcity/js/sims/br-trash-capture-device-service.js",
  "smartcity/js/sims/br-dredge-material-screening-and-disposal-decision.js",
  "smartcity/js/sims/br-cold-water-immersion-and-mob-recovery.js",
  "smartcity/js/sims/hz-level-b-entry-and-scba-change-out.js",
  "smartcity/js/sims/le-followspot-and-truss-access-at-height.js",
  "smartcity/js/sims/le-crowd-barricade-and-show-stop-call.js",
  "smartcity/js/sims/br-tidal-marsh-grading-amphibious-excavator.js",
  "smartcity/js/sims/br-vhf-and-navigation-in-a-work-zone.js",
  "smartcity/js/sims/br-native-planting-and-erosion-mats.js",
  "smartcity/js/sims/br-culvert-retrofit-for-fish-passage.js",
  "smartcity/js/sims/br-shoreline-cleanup-sharps-and-hazardous-debris.js",
  "smartcity/js/sims/br-intertidal-invasive-removal-by-hand-crew.js",
  "smartcity/js/sims/br-levee-inspection-and-seepage.js",
  "smartcity/js/sims/br-fish-screen-maintenance.js",
  "smartcity/js/sims/hz-drum-staging-and-compatibility-segregation.js",
  "smartcity/js/sims/hz-decon-corridor-for-a-mass-casualty-drill.js",
  "smartcity/js/sims/se-steam-trap-survey-and-condensate-return.js",
  "smartcity/js/sims/se-building-automation-alarm-triage.js",
  "smartcity/js/sims/po-lashing-gear-inspection-and-tagging.js",
  "smartcity/js/sims/po-yard-hostler-and-pedestrian-separation.js",
  "smartcity/js/sims/fp-anchor-selection-and-rescue-plan.js",
  "smartcity/js/sims/rl-critical-lift-plan-and-signalperson.js",
  "smartcity/js/sims/tr-wheelchair-lift-and-securement-on-a-bus.js",
  "smartcity/js/sims/et-ev-fleet-depot-charging-and-arc-flash.js",
  "smartcity/js/sims/bb-reset-routine-after-a-miss.js",
  "smartcity/js/sims/bb-pre-game-routine-and-visualisation.js",
  "smartcity/js/sims/br-marine-mammal-observer-during-pile-driving.js",
  "smartcity/js/sims/br-bird-nesting-buffer-and-work-window.js",
  "smartcity/js/sims/bb-composure-with-a-hostile-crowd-and-officials.js",
  "smartcity/js/sims/bb-teammate-conflict-and-accountability.js",
  "smartcity/js/sims/bb-coach-feedback-and-growth-mindset.js",
  "smartcity/js/sims/bb-final-possession-decision-under-pressure.js",
...
for (const sim of suite.SIMS) {
  ...
  for (const step of sim.steps) {
    ...
    if (step.kind === "drive") {
      const d = step.drive ?? {};
      if (!Array.isArray(d.path) || d.path.length < 2 || !d.path.every((p) => Array.isArray(p) && p.length === 2 && p.every(Number.isFinite))) fail(sim.id, `drive step "${step.id}" has no path of [x, z] points`);
      if (!Array.isArray(d.speedBand) || !(d.speedBand[0] >= 0 && d.speedBand[1] > d.speedBand[0])) fail(sim.id, `drive step "${step.id}" speedBand must be [lo, hi] with hi > lo`);
      if (!(d.laneWidth > 0)) fail(sim.id, `drive step "${step.id}" has no laneWidth`);
      for (const c of d.checks ?? []) {
        if (!suite.DRIVE_CHECKS.includes(c.kind)) fail(sim.id, `drive step "${step.id}" check "${c.kind}" is not one of ${suite.DRIVE_CHECKS.join("/")}`);
        if (!(Number.isInteger(c.at) && c.at >= 0 && c.at < (d.path?.length ?? 0))) fail(sim.id, `drive step "${step.id}" check "${c.kind}" sits at path index ${c.at}, which is not on the path`);
      }
      for (const [name, id] of Object.entries(d.controls ?? {})) if (!api.hits[id]) fail(sim.id, `drive step "${step.id}" control "${name}" names missing interactable "${id}"`);
      if (!step.holdBreakNote) fail(sim.id, `drive step "${step.id}" has no holdBreakNote for leaving the lane or the band`);
    }
    if (step.kind === "drag") {
  ...
  while (!session.finished && guard++ < 500) {
    ...
    if (step.kind === "select") session.select(step.target);
      ...
      // The policy runner drives: the lane centre at the band's midpoint, every
      // check in its window. A perfect run is one that policy finishes clean.
      for (let i = 0; i < 8000 && !session.finished && session.step === step; i++) {
        const a = suite.drivePolicy(session);
        session.driveInput(a);
        if (a.check) session.driveCheck(a.check);
        session.tick(0.05);
      }
